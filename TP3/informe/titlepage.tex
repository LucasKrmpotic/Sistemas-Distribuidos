\begin{titlepage}
    ...
    \textsc{\Large -Lic. en Sistemas OPGCPI-}\\[0.5cm] % Major heading such as course name
    ...
    \HRule \\[0.4cm]
    {\huge \bfseries -Laboratorio 3-}\\[0.4cm] % Title of your document
    {\large \bfseries -CGI-Ajax-NFS-DNS-}\\[0.4cm] % Title of your document
    \HRule \\[1.5cm]
    ...
    \begin{minipage}[l]{0.5\textwidth}
        \begin{flushleft}
            \textbf{\textsf{Cátedra}}\\
            \large Mg. Ricardo Antonio López\\ 
    ...
    \begin{minipage}[l]{0.4\textwidth}
        \begin{flushright}
            ...
            \linespread{1}
            \large Aguila Maximiliano\\
            \large Krmpotic Lucas\\
        \end{flushright}
    \end{minipage}\\[1.5cm]
