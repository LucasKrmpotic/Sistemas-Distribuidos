...
{\color{incolor}In [{\color{incolor}9}]:} \PY{k+kn}{from} \PY{n+nn}{scapy}\PY{n+nn}{.}\PY{n+nn}{all} \PY{k}{import} \PY{o}{*}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
HTTP/1.1 400 Bad Request
Date: Tue, 23 Oct 2018 19:36:51 GMT
...
Content-Language: en
Expires: Tue, 23 Oct 2018 19:36:51 GMT
